...
| company_name                  | phone           | country | Mitjana |
|-------------------------------|-----------------|---------|---------|
...
Para esto debo ir a Database/reverse Engineer

1. Tabla credit_card:
    - Ha agregado un campo llamado fecha_actual tipo _date_ 
    - Ha cambiado el tipo e variable de _cvv_ de **varchar** a **int**
2. Tabla transaction
    - en company_id ha indicado que Not NULL
    - 